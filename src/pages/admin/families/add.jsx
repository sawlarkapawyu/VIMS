        ...
        <>
            ...
            <Sidebar>
                ...
                <div className="grid grid-cols-1 pt-10 gap-x-8 gap-y-8 md:grid-cols-3">
                    ...
                    <form onSubmit={handleCreateFamily} className="bg-white shadow-sm ring-1 ring-gray-900/5 sm:rounded-xl md:col-span-2">
                            ...
                            <div className="sm:col-span-3">
                                ...
                                <div className="relative mt-2">
                                    <input
                                        ...
                                        placeholder="Search or Enter NRC Number"
                                        className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-sky-600 sm:text-sm sm:leading-6"
                                    />
